...
class TestAdvancedConfigurationUnit:
    ...
    def test_oauth_config_validation_logic(self):
        ...
        assert client_id.endswith(".apps.googleusercontent.com") or client_id.endswith(".googleusercontent.com")
    ...
    def test_environment_variable_precedence_logic(self):
        ...
        with patch.dict(os.environ, env_vars):
            ...
            assert loaded_vars["TEST_MCP_SERVERS_CONFIG_PATH"] == env_vars["TEST_MCP_SERVERS_CONFIG_PATH"]
    ...
    def test_missing_required_environment_variables_logic(self):
        ...
        with patch.dict(os.environ, {}, clear=False):
            ...
            if missing_vars:
                ...
                error_raised = True
                error_message = f"Missing required environment variable: {missing_vars[0]}"
            else:
                error_raised = False
                error_message = None
            ...
            assert error_raised
            assert error_message is not None and "Missing required environment variable" in error_message
    ...
    def test_unicode_in_configuration_logic(self):
        ...
        assert "café_users" in parsed_config["mcpServers"]["café_server"]["required_groups"]
...
class TestConfigurationEdgeCases:
    ...
    def test_malformed_server_configuration_logic(self):
        ...
        malformed_configs = [
            ...
            {"mcpServers": {"server1": {"command": "python", "args": "not_a_list"}}},  # Invalid args
        ]
    ...
    def test_circular_dependency_detection_logic(self):
        ...
        for server_name, server_config in servers.items():
            ...
            references_other_servers = any(other_server in str(args) for other_server in server_names if other_server != server_name)
