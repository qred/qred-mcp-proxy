...
class TestPerformance:
    ...
    def test_discovery_endpoint_caching(self, client):
        ...
        print(f"First request: {first_response_time:.3f}s, Second request: {second_response_time:.3f}s")
    ...
    def test_startup_time(self):
        ...
        with patch.dict('os.environ', {
            ...
            with patch("mcp_oauth.server.initialize_mcp_servers_config_async", new_callable=AsyncMock):
                from mcp_oauth.server import app
