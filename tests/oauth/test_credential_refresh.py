...
class TestCredentialRefresh:
    ...
    def mock_credentials_expiring_soon(self):
        ...
        mock_credentials._expiry_time = datetime.now(timezone.utc) + timedelta(minutes=2)
    ...
    def test_credential_expiry_detection_logic(self, mock_credentials_expiring_soon, mock_session):
        ...
        time_until_expiry = mock_credentials_expiring_soon._expiry_time - datetime.now(timezone.utc)
    ...
    def test_credential_expiry_no_refresh_needed_logic(self, mock_credentials_valid, mock_session):
        ...
        # Test the expiry detection logic
        time_until_expiry = mock_credentials_valid._expiry_time - datetime.now(timezone.utc)
    ...
    def test_error_detection_methods(self):
        ...
        for error_msg in expired_errors:
            ...
            is_expired_error = any(phrase in error_str for phrase in [
                'expired token', 'expiredtoken', 'invalid_grant', 
        ...
        for error_msg in non_expired_errors:
            ...
            assert not is_expired_error, f"Should not detect '{error_msg}' as expired error"
    ...
    def test_session_credential_refresh_integration_logic(self, mock_credentials_expiring_soon):
