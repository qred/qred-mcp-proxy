...
keepalive_formatter = logging.Formatter(
    "%(asctime)s - KEEP_ALIVE_LOG - %(levelname)s - %(message)s"
)
...
keepalive_console_formatter = logging.Formatter(
    "%(asctime)s - KEEP_ALIVE - %(levelname)s - %(message)s"
)
